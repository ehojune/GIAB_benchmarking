...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| HiFi CCS (HudsonAlpha) | HG001 | Sequel II (m64109) | 66 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi SequelII 11kb | HG001 | Sequel II | 110 | ✓ FASTQ | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi chemistry2 | HG001 | Sequel II (m64109) | 210 | ✓ hifi_reads/uBAM | △ 6개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ N/A | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi CCS 10kb | HG002 | Sequel | 282 | ✓ FASTQ | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi CCS 15kb | HG002 | Sequel | 292 | ✓ FASTQ | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi Revio 20231031 | HG002 | Revio (m84039) | 287 | ✓ hifi_reads/uBAM | △ 2개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi SequelII 11kb | HG002 | Sequel II | 209 | ✓ FASTQ | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi chemistry2 | HG002 | Sequel II | 573 | ✓ FASTQ | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi CCS (Google) | HG003 | Sequel II | 45 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi CCS (HudsonAlpha) | HG003 | Sequel II (m64017) | 191 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 파일명 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi Revio 20231031 | HG003 | Revio (m84039) | 276 | ✓ hifi_reads/uBAM | △ 2개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi chemistry2 | HG003 | Sequel II (m64017) | 658 | ✓ hifi_reads/uBAM | △ 6개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ ccs v6.2.0 +1 | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi CCS (Google) | HG004 | Sequel II (m64017) | 43 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi CCS (HudsonAlpha) | HG004 | Sequel II (m64017) | 196 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi Revio 20231031 | HG004 | Revio (m84039) | 208 | ✓ hifi_reads/uBAM | △ 2개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi chemistry2 | HG004 | Sequel II (m64017) | 577 | ✓ hifi_reads/uBAM | △ 6개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ N/A | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi CCS (HudsonAlpha) | HG005 | Sequel II (m64109, m64017) | 119 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi SequelII 11kb | HG005 | Sequel II | 123 | ✓ FASTQ | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi chemistry2 | HG005 | Sequel II (m64109, m64017) | 369 | ✓ hifi_reads/uBAM | △ 7개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ N/A | – | ✗ | 파일명 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi (Google) | HG006 | Sequel II | 56 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi chemistry2 | HG006 | Sequel II (m64017, m64109) | 386 | ✓ hifi_reads/uBAM | △ 6개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ N/A | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi (Google) | HG007 | Sequel II (m64062) | 44 | ✓ FASTQ | – | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | – | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi chemistry2 | HG007 | Sequel II (m64017) | 380 | ✓ hifi_reads/uBAM | △ 6개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ N/A | – | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi Revio (BCM) 20240313 | HG008 | Revio (m84059, m84101) | 757 | ✓ hifi_reads | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools +1 | ✓ Severus — PacBio Somatic Pipe… | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| HiFi Revio 20240125 | HG008 | Revio (m84039) | 637 | ✓ hifi_reads/uBAM | △ 3개 | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools | ✗ | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| N bulk HiFi Revio + somatic | HG009 | Revio (m84059) | 428 | ✓ uBAM/BAM | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools v2.3.1 +2 | ✓ DeepSomatic v1.9.0 +4 | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| T bulk HiFi Revio + somatic | HG009 | Revio (m84059, m84113) | 335 | ✓ uBAM/BAM | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools v2.3.1 +2 | ✓ DeepSomatic v1.9.0 +4 | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
| T 단일세포 클론 6종 HiFi Revio + somatic | HG009 | Revio (m84059, m84113) | 779 | ✓ uBAM/BAM | ✓ | ✓ pbmm2 v26.2.0 *(나)* | ✓ WhatsHap v2.8 *(나)* | ✓ DeepVariant v1.10.0 + Clair3… *(나)* | ✓ pb-CpG-tools v2.3.1 +2 | ✓ DeepSomatic v1.9.0 +4 | ✗ | 문서 | phase1 raw→VCF 완료 (pbmm2 정렬 + DeepVariant/Clair3 + pbsv +… |
...
| ONT-UL Guppy 3.4.5 (align only) | HG002 | ONT ultralong | 545 | ✓ fastq | ✓ | ✓ minimap2 vb09096fc890429ce *(나)* | ✓ LongPhase v2.0.2 *(나)* | ✓ Clair3 v1.2.0 + Sniffles2 v2.… *(나)* | – | – | ✗ | 문서 | phase2 raw→VCF 완료 (minimap2 정렬 + Clair3 + Sniffles2 + Lon… |
