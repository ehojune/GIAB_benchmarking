> 2026-09-25 범위 조정 전 기록. 현재 지시가 아니며 [SCOPE](../SCOPE.md)와 [STATUS](../STATUS.md)를 먼저 본다. 상대 링크만 이동 위치에 맞췄다.

# 백로그 — 아직 안 한 일의 상세

[STATUS.md](2026-09-25-status-before-scope-reset.md) 작업 흐름 표의 **#8·#9·#10 행이 가리키는 상세**다.
