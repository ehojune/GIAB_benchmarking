...
| 같은 버킷 `novaseqx/` | HG002만: NovaSeq 6000 10~60x, NovaSeq X 10~40x 시리즈 (SRA SRR37356338 등) | HTTPS 익명 | 깊이 적정(titration) 후보 |
| ENA PRJNA1427896 (Weill Cornell, 2026-03) | HG002만: NovaSeq X 25B/10B 3런(~35x, 2x150) + UG100 5런 | ENA | 트리오 아님 |
