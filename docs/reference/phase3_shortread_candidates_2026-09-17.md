...
| 같은 버킷 `novaseqx/` | HG002만: NovaSeq 6000 10~60x(같은 런 HV3C3DSXX), NovaSeq X 10~40x + 전체(SRR37356338 재배포, 헤더 `pi1-04:533:22JTGYLT4`, 2x150) | HTTPS 익명, md5 | **채택(HG002.NovaSeqX_30x)** — 업체 화학(XLEAP-SBS) 맞춘 HG002 대조군. ENA SRX32270094 design: NovaSeq X 25B, 2x151, v1.3, TruSeq DNA PCR-Free, 64-plex. 30x: R1 22,344,558,277 B md5 c9a66aaa3b932ead2c4750726a475a32 / R2 22,168,774,900 B md5 1d2ca0d3803ed2dcbf574710119eaef8. 전체: R1 32,312,362,334 B 72ef3765…, R2 32,058,778,610 B 254ca0dc… |
