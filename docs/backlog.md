...
| 2 | GIAB 기본 잡 5개 유지. HG003 Manta 단일 복구 잡 **156780** 결과 확인·검증 후 반영 | [복구 기록](runs/2026-09-25-illumina-hg003-manta-retry.md), 산출물·현재 완료 로그·QC. 상위 잡 중복 재시작·20 set 일괄 제출 금지 |
