...
| 2 | 진행 중인 GIAB 기본 잡 5개 완료 확인(08:13–16 CPU 증가). 고정 카탈로그에서 미처리 기본 run만 식별 | 산출물·완료 로그·QC 또는 `gap` 사유. 추가 20 set을 무조건 한꺼번에 제출하지 않음 |
...
| 5 | ~~PacBio 담당이 제출한 somatic 전장 **156747–156759** 결과 확인·채점~~ **완료 09-25** | 13쌍 exit 0·채점 완료, [runs/2026-09-25-somatic-wgs.md](runs/2026-09-25-somatic-wgs.md) |
