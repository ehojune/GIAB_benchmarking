...
| 순서 | 남은 일 | 완료 표시 |
|---|---|---|
| 1 | **총괄(Claude, 09-26~)이 비교 시점·실행 담당 관리**. 회사 gd1~4 **156760–156763** 완료·간단 QC 후 공개 NovaSeq6000 trio·NovaSeqX HG002와 기존 hap.py/v4.2.1 비교 | PacBio의 같은 작업은 23:52 보류. 정본 1–3 KOR·4–6 HG와 새 산출물 확인, SNP·INDEL precision/recall/F1 표. 옛 업체 캐시 재사용 금지. 도구는 브랜치 `claude/phase3-07-happy`(main 미통합) |
| 2 | GIAB 기본 잡 4개(155526–155528, 156690) 유지. Illumina-250PE는 정리 후 **156786** `regermline` 1회 재개(09-26 09:04) | [실행 기록](runs/2026-09-26-illumina-regermline-retry.md)의 판정 기준. 또 실패하면 SV·verifybamID `gap`, 재시도 없음. 같은 세트 중복 실행·20 set 일괄 제출 금지 |
...
**총괄(09-26부터 Claude 세션, Codex 장애) 단일 담당의 4시간 점검·보고와 승인 범위의 후속 작업은 진행한다.** somatic 13쌍은 QC·채점까지 완료했으므로 다시 제출하지 않는다.
