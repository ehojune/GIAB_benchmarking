...
- manifest는 FTP를 그대로 따른다: 추가 1,525 files(31.9 GiB), 제거 52(HG002 latest/의 v4.2.1 51 + references README.md.txt).
...
- `data/`·`data_somatic/`·`data_RNAseq/`는 크롤하지 않았다. 필요하면 `ROOT=data/...`로 같은 스크립트를 쓴다.
