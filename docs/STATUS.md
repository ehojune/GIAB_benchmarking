...
| 5b | **phase1 PacBio SV 평가** (`s1.*`, Truvari vs v5.0q, HG002 5런) | **5/5 완료** (`-t 8` 재실행, exit 0, wall 247~257초, maxvmem 91.6~136.2 GB) | 156048~156052 | `--collect` 수치로 참고 문서 SV 표 교체 (지금 표는 `-t 22` 1차분) | 없음 |
