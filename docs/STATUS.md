...
2026-09-25 21:46–21:51 관리자 서버 확인. 회사 세부 QC와 카탈로그 대조는 19:52 점검 기준. 완료 기준은 [SCOPE](SCOPE.md). 실행 중인 잡과 완료된 카탈로그 결과를 구분한다. somatic 누락 13행을 반영했고 TSV·Excel **442행 × 51열 대조 차이 0**이다.
