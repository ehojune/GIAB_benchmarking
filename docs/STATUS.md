...
2026-09-26 20:04 KST 확인. **기본 6잡 CPU·로그 증가, fastp 보고서 복원 2잡 실행 중, 다운로드 61.23%.** 완료된 비교 7건의 [첫 점수표](reports/2026-09-26-shortread-first-seven.md)를 정리했다. [이번 근거](reference/2026-09-26-2004-status-evidence.json).
