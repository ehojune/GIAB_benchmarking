...
전 런이 germline 기대치 2.0~2.1보다 낮은 게(R9 1.86~1.97, R10 1.65~1.77) FP 과다 신호인 건 맞는데,
**그 FP가 벤치마크 구간 밖에 몰려 있다.** benchmark BED로 갈라 세면:
...
구간 안 SNP precision이 0.990~0.999인 것과도 맞는다.

구간 밖 값은 베이스콜러가 좋을수록 오히려 **낮다**(R10 dorado 1.15 < guppy 4.2.2 1.30 < 3.2.x 1.48).
좋은 베이스콜러가 어려운 영역까지 더 부르고(R10 구간 밖 1.20M vs R9 0.97~1.12M) 그 한계 콜이
FP 비중이 높기 때문으로 보인다.
